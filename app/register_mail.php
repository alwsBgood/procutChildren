...
$recepient = "imindcancer@gmail.com, sidelnikow88@gmail.com, sv@lexstatus.com.ua";
$sitename = "procut.com.ua";
...
$query = "INSERT INTO procut_leads set name='$name', phone='$phone', mail='$mail', utm_source='$utm_source', utm_campaign='$utm_campaign', utm_medium='$utm_medium', date_submitted=NOW(), time_submitted=CURTIME(), page_url='$page_url', ref='$ref', utm_term='$utm_term', utm_content='$utm_content', ip_address='$ip_address', is_test=case when (lower(name) like '%test%' OR lower(name) like '%тест%' OR ip_address ='62.80.163.149') then 1 else 0 end";

mysql_query ("SET NAMES utf8");
mysql_query ( $query );

// if($page_url == 'http://procut.com.ua/course/final-cut-pro-x'){
// 	$version = 'procut_X';
// }
// if($page_url == 'http://procut.com.ua/course/final-cut-pro'){
// 	$version = 'procut_PRO';
// }
...
// $user = 'dmitr-diachenko@yandex.ru';
